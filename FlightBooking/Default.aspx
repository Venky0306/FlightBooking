<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="FlightBooking._Default" %>
  ...
  <div class="w3-display-middle" style="width:65%">
    ...
    <div id="Flight" class="w3-container w3-white w3-padding-16 myLink">
      ...
      <div class="w3-row-padding" style="margin:0 -16px;">
        <div class="w3-half">
          <label>From  </label>
            <asp:DropDownList runat="server" DataSourceID="Source" ID="ctl00"></asp:DropDownList>                    </div>
        <div class="w3-half">
          <label>To  </label>
            <asp:DropDownList runat="server" DataSourceID="Source" ID="ctl01"></asp:DropDownList>          
        </div>
      </div>
